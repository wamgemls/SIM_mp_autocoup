...
class KingpinEmulationNode(Node):
    ...
    def __init__(self):
        ...
        self.kingpin_pose_odom_pub = self.create_publisher(PoseStamped, "/pln/kingpin_emulation/truck_odom",10)
        self.kingpin_pose_base_pub = self.create_publisher(PoseStamped, "/pln/kingpin_emulation/truck_base",10)
        
        self.timer_init = self.create_timer(5.0,self.init)
    ...
    def cycle(self):
        ...
        self.transform_global2odom()
        self.transform_global2base()
    
        self.publish_kingpin_pose_msg()

    def give_ego_in_global(self):
    ...
    def transform_global2odom(self):
    ...
    def transform_global2base(self):
    ...
    def publish_kingpin_pose_msg(self):
        self.kingpin_pose_base_pub.publish(self.kingpin_pose_truckodom)
        self.kingpin_pose_base_pub.publish(self.kingpin_pose_truckbase)
