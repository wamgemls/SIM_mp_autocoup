...
class PlannerGUI(QtWidgets.QMainWindow):
    ...
    def update_status_screen(self):
        ...
        self.tab1.labelupdate(  round(self.planner_data.ego_x,2),round(self.planner_data.ego_y,2),round(self.planner_data.ego_yaw,2),
                                round(self.planner_data.ego_vx,2),round(self.planner_data.ego_curvature,2),
                                round(self.planner_data.prekingpin_x,2),round(self.planner_data.prekingpin_y,2),round(self.planner_data.prekingpin_yaw,2),
                                round(self.planner_data.kingpin_x,2),round(self.planner_data.kingpin_y,2),round(self.planner_data.kingpin_yaw,2),
